...
namespace CareWell.BusinessService.Test.EquipoCuidado
{
    public class AdministrarPersonasCargoBusinessTest : BusinessTestClassBase<AdministrarPersonasCargoBusinessService>
    {
        ...
        public class ElMetodo_EliminarAsignacion : AdministrarPersonasCargoBusinessTest
        {
        ...
        public class ElMetodo_ActivarAsignacion : AdministrarPersonasCargoBusinessTest
        {
            private int asignacionCuidadoID;
            private Mock<AsignacionCuidado> asignacionCuidado;
        ...
        public class ElMetodo_ReactivarAsignacion : AdministrarPersonasCargoBusinessTest
        {
            private int asignacionCuidadoID;
            private Mock<AsignacionCuidado> asignacionCuidado;
