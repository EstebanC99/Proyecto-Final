...
namespace CareWell.Domain.Test.Validadores
{
    public class ValidadorPermisoAccionTest : TestClassBase<ValidadorPermisoAccion>
    {
        ...
        public class ElMetodo_ValidarPuedeAdministrarEventosSalud : ValidadorPermisoAccionTest
        {
            private Mock<Persona> personaCuidada;
            private Mock<Persona> colaborador;
            private Mock<AsignacionCuidado> asignacionCuidado;
            ...
            protected override void InitializeTest()
            {
                ...
                this.asignacionCuidado.Setup(s => s.PersonaCuidada).Returns(this.personaCuidada.Object);
                this.asignacionCuidado.Setup(s => s.Colaborador).Returns(this.colaborador.Object);
                this.asignacionCuidado.Setup(s => s.Permisos).Returns(new List<PermisoCuidado> { Mock.Of<PermisoCuidado>(p => p.ID == PermisosCuidado.RegistrarEventosSalud) });
                this.asignacionCuidado.Setup(s => s.Estado).Returns(Mock.Of<EstadoAsignacionCuidado>(e => e.ID == EstadosAsignacionCuidado.Activa));
            ...
            private void Action()
            {
                this.Target.ValidarPuedeAdministrarEventosSalud(this.personaCuidada.Object,
                                                                this.colaborador.Object);
            }
            ...
            [Fact]
            public void Si_en_la_asignacion_cuidado_entre_la_persona_a_cuidar_y_el_asignador_no_tiene_el_permiso_de_registrar_eventos_de_salud_arroja_un_ValidacionDominioException_con_mensaje_informativo()
            {
                // Arrange
                this.asignacionCuidado.Setup(s => s.Permisos).Returns(new List<PermisoCuidado> { Mock.Of<PermisoCuidado>(p => p.ID == PermisosCuidado.ActivarEmergencia) });
        ...
        public class ElMetodo_ValidarPuedeRegistrarHabitos : ValidadorPermisoAccionTest
        {
            private Mock<Persona> personaCuidada;
            private Mock<Persona> colaborador;
            private Mock<AsignacionCuidado> asignacionCuidado;
            ...
            protected override void InitializeTest()
            {
                ...
                this.asignacionCuidado.Setup(s => s.PersonaCuidada).Returns(this.personaCuidada.Object);
                this.asignacionCuidado.Setup(s => s.Colaborador).Returns(this.colaborador.Object);
                this.asignacionCuidado.Setup(s => s.Permisos).Returns(new List<PermisoCuidado> { Mock.Of<PermisoCuidado>(p => p.ID == PermisosCuidado.RegistrarHabitos) });
                this.asignacionCuidado.Setup(s => s.Estado).Returns(Mock.Of<EstadoAsignacionCuidado>(e => e.ID == EstadosAsignacionCuidado.Activa));
            ...
            private void Action()
            {
                this.Target.ValidarPuedeRegistrarHabitos(this.personaCuidada.Object,
                                                         this.colaborador.Object);
            }
            ...
            [Fact]
            public void Si_en_la_asignacion_cuidado_entre_la_persona_a_cuidar_y_el_asignador_no_tiene_el_permiso_de_registrar_habitos_arroja_un_ValidacionDominioException_con_mensaje_informativo()
            {
                // Arrange
                this.asignacionCuidado.Setup(s => s.Permisos).Returns(new List<PermisoCuidado> { Mock.Of<PermisoCuidado>(p => p.ID == PermisosCuidado.ActivarEmergencia) });
        ...
        public class ElMetodo_ValidarPuedeActivarEmergencia : ValidadorPermisoAccionTest
        {
            private Mock<Persona> personaCuidada;
            private Mock<Persona> colaborador;
            private Mock<AsignacionCuidado> asignacionCuidado;
            ...
            private void Action()
            {
                this.Target.ValidarPuedeActivarEmergencia
                (
                    this.personaCuidada.Object,
                    this.colaborador.Object
                );
            }
            ...
            [Fact]
            public void Si_en_la_asignacion_cuidado_entre_la_persona_a_cuidar_y_el_asignador_no_tiene_el_permiso_de_activar_emergencia_arroja_un_ValidacionDominioException_con_mensaje_informativo()
            {
                // Arrange
                this.asignacionCuidado.Setup(s => s.Permisos).Returns(new List<PermisoCuidado> { Mock.Of<PermisoCuidado>(p => p.ID == PermisosCuidado.EditarFichaSalud) });
