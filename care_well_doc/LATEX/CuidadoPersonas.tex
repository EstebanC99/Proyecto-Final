...
% Tamaño del Sistema
    ...
    \begin{itemize}
        ...
        \item \textbf{Baja de miembro del equipo (capa demo):} en la implementación demo, la baja de un miembro elimina la asignación. En producción, la baja debería marcar la asignación como inactiva, preservando su trazabilidad histórica.
